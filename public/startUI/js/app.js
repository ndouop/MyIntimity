...
/* ==========================================================================
	...
	if (!("ontouchstart" in document.documentElement)) {
		...
		$('.chat-history').jScrollPane(jScrollOptions);
	}
...
/* ==========================================================================
	...
	var recomendationsSlider_2 = $('.recomendations-slider_2');

	recomendationsSlider_2.slick({
		slidesToShow: 4,
		adaptiveHeight: true,
		arrows: false,
		responsive: [
	...
	$('.recomendations-slider-prev_2').click(function(){
		recomendationsSlider_2.slick('slickPrev');
	});

	$('.recomendations-slider-next_2').click(function(){
		recomendationsSlider_2.slick('slickNext');
	});
