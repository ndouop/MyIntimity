...
<head lang="en">
	...
	<title>{{\Config::get("app.name")}} - Page not Found</title>
        ...
        <div class="page-center-in">
            <div class="container-fluid">
                <div class="page-error-box">
                    <div class="error-code"><img src="{{asset('images/500_1.PNG')}}"></div>
                    <div class="error-title">{!! trans('front/exceptions.msg_500') !!}</div>
